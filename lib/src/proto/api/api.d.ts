...
import type { ExchangeCreateContract, ExchangeInjectContract, ExchangeTransactionContract, ExchangeWithdrawContract } from '../core/contract/exchange_contract';
import type { MarketCancelOrderContract, MarketSellAssetContract } from '../core/contract/market_contract';
import type { ProposalApproveContract, ProposalCreateContract, ProposalDeleteContract } from '../core/contract/proposal_contract';
import type { IncrementalMerkleTree, IncrementalMerkleVoucher, IncrementalMerkleVoucherInfo, OutputPointInfo, ReceiveDescription, SpendDescription } from '../core/contract/shield_contract';
import type { FundInjectContract, SideChainProposalCreateContract } from '../core/contract/sidechain';
import type { ClearABIContract, CreateSmartContract, SmartContract, SmartContractDataWrapper, TriggerSmartContract, UpdateEnergyLimitContract, UpdateSettingContract } from '../core/contract/smart_contract';
import type { BuyStorageBytesContract, BuyStorageContract, SellStorageContract, UpdateBrokerageContract } from '../core/contract/storage_contract';
import type { VoteWitnessContract, WitnessCreateContract, WitnessUpdateContract } from '../core/contract/witness_contract';
...
export declare const Return_response_code: {
    readonly SUCCESS: "SUCCESS";
    /** SIGERROR - error in signature */
    readonly SIGERROR: "SIGERROR";
    readonly CONTRACT_VALIDATE_ERROR: "CONTRACT_VALIDATE_ERROR";
    readonly CONTRACT_EXE_ERROR: "CONTRACT_EXE_ERROR";
    readonly BANDWITH_ERROR: "BANDWITH_ERROR";
    readonly DUP_TRANSACTION_ERROR: "DUP_TRANSACTION_ERROR";
    readonly TAPOS_ERROR: "TAPOS_ERROR";
    readonly TOO_BIG_TRANSACTION_ERROR: "TOO_BIG_TRANSACTION_ERROR";
    readonly TRANSACTION_EXPIRATION_ERROR: "TRANSACTION_EXPIRATION_ERROR";
    readonly SERVER_BUSY: "SERVER_BUSY";
    readonly NO_CONNECTION: "NO_CONNECTION";
    readonly NOT_ENOUGH_EFFECTIVE_CONNECTION: "NOT_ENOUGH_EFFECTIVE_CONNECTION";
    readonly OTHER_ERROR: "OTHER_ERROR";
};
export declare type Return_response_code = typeof Return_response_code[keyof typeof Return_response_code];
...
export declare const TransactionSignWeight_Result_response_code: {
    readonly ENOUGH_PERMISSION: "ENOUGH_PERMISSION";
    /** NOT_ENOUGH_PERMISSION - error in */
    readonly NOT_ENOUGH_PERMISSION: "NOT_ENOUGH_PERMISSION";
    readonly SIGNATURE_FORMAT_ERROR: "SIGNATURE_FORMAT_ERROR";
    readonly COMPUTE_ADDRESS_ERROR: "COMPUTE_ADDRESS_ERROR";
    /** PERMISSION_ERROR - The key is not in permission */
    readonly PERMISSION_ERROR: "PERMISSION_ERROR";
    readonly OTHER_ERROR: "OTHER_ERROR";
};
export declare type TransactionSignWeight_Result_response_code = typeof TransactionSignWeight_Result_response_code[keyof typeof TransactionSignWeight_Result_response_code];
...
export declare const TransactionApprovedList_Result_response_code: {
    readonly SUCCESS: "SUCCESS";
    readonly SIGNATURE_FORMAT_ERROR: "SIGNATURE_FORMAT_ERROR";
    readonly COMPUTE_ADDRESS_ERROR: "COMPUTE_ADDRESS_ERROR";
    readonly OTHER_ERROR: "OTHER_ERROR";
};
export declare type TransactionApprovedList_Result_response_code = typeof TransactionApprovedList_Result_response_code[keyof typeof TransactionApprovedList_Result_response_code];
...
export interface Wallet {
    ...
    GetAccountBalance(request: AccountBalanceRequest): Promise<AccountBalanceResponse>;
    GetBlockBalanceTrace(request: BlockBalanceTrace_BlockIdentifier): Promise<BlockBalanceTrace>;
    ...
    CreateTransaction2(request: TransferContract): Promise<TransactionExtention>;
    ...
    UpdateAccount2(request: AccountUpdateContract): Promise<TransactionExtention>;
    ...
    UpdateSetting(request: UpdateSettingContract): Promise<TransactionExtention>;
    /** modify the energy_limit */
    UpdateEnergyLimit(request: UpdateEnergyLimitContract): Promise<TransactionExtention>;
    /** Use this function instead of VoteWitnessAccount. */
    VoteWitnessAccount2(request: VoteWitnessContract): Promise<TransactionExtention>;
    ...
    CreateAssetIssue2(request: AssetIssueContract): Promise<TransactionExtention>;
    ...
    UpdateWitness2(request: WitnessUpdateContract): Promise<TransactionExtention>;
    ...
    CreateAccount2(request: AccountCreateContract): Promise<TransactionExtention>;
    ...
    CreateWitness2(request: WitnessCreateContract): Promise<TransactionExtention>;
    ...
    TransferAsset2(request: TransferAssetContract): Promise<TransactionExtention>;
    /** Please use ParticipateAssetIssue2 instead of this function. */
    ParticipateAssetIssue(request: ParticipateAssetIssueContract): Promise<Transaction>;
    /** Use this function instead of ParticipateAssetIssue. */
    ParticipateAssetIssue2(request: ParticipateAssetIssueContract): Promise<TransactionExtention>;
    ...
    FreezeBalance2(request: FreezeBalanceContract): Promise<TransactionExtention>;
    ...
    UnfreezeBalance2(request: UnfreezeBalanceContract): Promise<TransactionExtention>;
    ...
    UnfreezeAsset2(request: UnfreezeAssetContract): Promise<TransactionExtention>;
    ...
    WithdrawBalance2(request: WithdrawBalanceContract): Promise<TransactionExtention>;
    ...
    ProposalCreate(request: ProposalCreateContract): Promise<TransactionExtention>;
    ProposalApprove(request: ProposalApproveContract): Promise<TransactionExtention>;
    ProposalDelete(request: ProposalDeleteContract): Promise<TransactionExtention>;
    BuyStorage(request: BuyStorageContract): Promise<TransactionExtention>;
    BuyStorageBytes(request: BuyStorageBytesContract): Promise<TransactionExtention>;
    SellStorage(request: SellStorageContract): Promise<TransactionExtention>;
    ExchangeCreate(request: ExchangeCreateContract): Promise<TransactionExtention>;
    ExchangeInject(request: ExchangeInjectContract): Promise<TransactionExtention>;
    ExchangeWithdraw(request: ExchangeWithdrawContract): Promise<TransactionExtention>;
    ExchangeTransaction(request: ExchangeTransactionContract): Promise<TransactionExtention>;
    MarketSellAsset(request: MarketSellAssetContract): Promise<TransactionExtention>;
    MarketCancelOrder(request: MarketCancelOrderContract): Promise<TransactionExtention>;
    ...
    GetMarketOrderListByPair(request: MarketOrderPair): Promise<MarketOrderList>;
    ...
    GetTransactionCountByBlockNum(request: NumberMessage): Promise<NumberMessage>;
    ...
    TriggerContract(request: TriggerSmartContract): Promise<TransactionExtention>;
    TriggerConstantContract(request: TriggerSmartContract): Promise<TransactionExtention>;
    ...
    GetDelegatedResource(request: DelegatedResourceMessage): Promise<DelegatedResourceList>;
    GetDelegatedResourceAccountIndex(request: BytesMessage): Promise<DelegatedResourceAccountIndex>;
    ...
    GetPaginatedAssetIssueList(request: PaginatedMessage): Promise<AssetIssueList>;
     ...
     */
    GetTransactionSign2(request: TransactionSign): Promise<TransactionExtention>;
    /** Warning: do not invoke this interface provided by others. */
    CreateAddress(request: BytesMessage): Promise<BytesMessage>;
    /** Warning: do not invoke this interface provided by others. */
    EasyTransferAsset(request: EasyTransferAssetMessage): Promise<EasyTransferResponse>;
    /** Warning: do not invoke this interface provided by others. */
    EasyTransferAssetByPrivate(request: EasyTransferAssetByPrivateMessage): Promise<EasyTransferResponse>;
    /** Warning: do not invoke this interface provided by others. */
    EasyTransfer(request: EasyTransferMessage): Promise<EasyTransferResponse>;
    /** Warning: do not invoke this interface provided by others. */
    EasyTransferByPrivate(request: EasyTransferByPrivateMessage): Promise<EasyTransferResponse>;
    /** Warning: do not invoke this interface provided by others. */
    ...
    AccountPermissionUpdate(request: AccountPermissionUpdateContract): Promise<TransactionExtention>;
    AddSign(request: TransactionSign): Promise<TransactionExtention>;
    GetTransactionSignWeight(request: Transaction): Promise<TransactionSignWeight>;
    GetTransactionApprovedList(request: Transaction): Promise<TransactionApprovedList>;
    ...
    UpdateBrokerage(request: UpdateBrokerageContract): Promise<TransactionExtention>;
    /** for shiededTransaction */
    CreateShieldedTransaction(request: PrivateParameters): Promise<TransactionExtention>;
    GetMerkleTreeVoucherInfo(request: OutputPointInfo): Promise<IncrementalMerkleVoucherInfo>;
    ScanNoteByIvk(request: IvkDecryptParameters): Promise<DecryptNotes>;
    ScanAndMarkNoteByIvk(request: IvkDecryptAndMarkParameters): Promise<DecryptNotesMarked>;
    ScanNoteByOvk(request: OvkDecryptParameters): Promise<DecryptNotes>;
    GetSpendingKey(request: EmptyMessage): Promise<BytesMessage>;
    GetExpandedSpendingKey(request: BytesMessage): Promise<ExpandedSpendingKeyMessage>;
    GetAkFromAsk(request: BytesMessage): Promise<BytesMessage>;
    GetNkFromNsk(request: BytesMessage): Promise<BytesMessage>;
    GetIncomingViewingKey(request: ViewingKeyMessage): Promise<IncomingViewingKeyMessage>;
    ...
    GetZenPaymentAddress(request: IncomingViewingKeyDiversifierMessage): Promise<PaymentAddressMessage>;
    GetRcm(request: EmptyMessage): Promise<BytesMessage>;
    IsSpend(request: NoteParameters): Promise<SpendResult>;
    CreateShieldedTransactionWithoutSpendAuthSig(request: PrivateParametersWithoutAsk): Promise<TransactionExtention>;
    ...
    CreateShieldedContractParameters(request: PrivateShieldedTRC20Parameters): Promise<ShieldedTRC20Parameters>;
    CreateShieldedContractParametersWithoutAsk(request: PrivateShieldedTRC20ParametersWithoutAsk): Promise<ShieldedTRC20Parameters>;
    ScanShieldedTRC20NotesByIvk(request: IvkDecryptTRC20Parameters): Promise<DecryptNotesTRC20>;
    ScanShieldedTRC20NotesByOvk(request: OvkDecryptTRC20Parameters): Promise<DecryptNotesTRC20>;
    IsShieldedTRC20ContractNoteSpent(request: NfTRC20Parameters): Promise<NullifierResult>;
    GetTriggerInputForShieldedTRC20Contract(request: ShieldedTRC20TriggerContractParameters): Promise<BytesMessage>;
    CreateCommonTransaction(request: Transaction): Promise<TransactionExtention>;
    GetTransactionInfoByBlockNum(request: NumberMessage): Promise<TransactionInfoList>;
    GetBurnTrx(request: EmptyMessage): Promise<NumberMessage>;
    GetTransactionFromPending(request: BytesMessage): Promise<Transaction>;
    GetTransactionListFromPending(request: EmptyMessage): Promise<TransactionIdList>;
...
export interface WalletExtension {
    ...
    GetTransactionsFromThis(request: AccountPaginated): Promise<TransactionList>;
    /** Use this function instead of GetTransactionsFromThis. */
    GetTransactionsFromThis2(request: AccountPaginated): Promise<TransactionListExtention>;
    ...
    GetTransactionsToThis2(request: AccountPaginated): Promise<TransactionListExtention>;
}
